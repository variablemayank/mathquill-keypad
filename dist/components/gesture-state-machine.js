...
var GestureStateMachine = function () {
    ...
    _createClass(GestureStateMachine, [{
        ...
        value: function _cleanupTouchEvent(touchId) {
            // console.log("gesture-state-machine.cleanupTouchEvent", touchId)
        ...
        value: function _onFocus(id, touchId) {
            ...
            // console.log('gesture-state-machine._onFocus', id, touchId)
            ...
            if (id) {
                // console.log(this.multiPressableKeys)
        ...
        value: function onTouchMove(getId, touchId, pageX, swipeEnabled) {
            // console.log("gesture-state-machine.onTouchMove");
            if (this.swipeState) {
        ...
        value: function onTouchCancel(touchId) {
            // console.log("gesture-state-machine.onTouchCancel");
