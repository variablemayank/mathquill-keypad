...
var KeyActions = (_KeyActions = {}, _defineProperty(_KeyActions, Keys.PLUS, { str: '+', fn: WRITE }), _defineProperty(_KeyActions, Keys.MINUS, { str: '-', fn: WRITE }), _defineProperty(_KeyActions, Keys.NEGATIVE, { str: '-', fn: WRITE }), _defineProperty(_KeyActions, Keys.TIMES, { str: '\\times', fn: WRITE }), _defineProperty(_KeyActions, Keys.DIVIDE, { str: '\\div', fn: WRITE }), _defineProperty(_KeyActions, Keys.DECIMAL, {
    str: decimalSymbol,
    fn: WRITE
}), _defineProperty(_KeyActions, Keys.EQUAL, { str: '=', fn: WRITE }), _defineProperty(_KeyActions, Keys.NEQ, { str: '\\neq', fn: WRITE }), _defineProperty(_KeyActions, Keys.CDOT, { str: '\\cdot', fn: WRITE }), _defineProperty(_KeyActions, Keys.PERCENT, { str: '%', fn: WRITE }), _defineProperty(_KeyActions, Keys.LEFT_PAREN, { str: '(', fn: CMD }), _defineProperty(_KeyActions, Keys.RIGHT_PAREN, { str: ')', fn: CMD }), _defineProperty(_KeyActions, Keys.SQRT, { str: 'sqrt', fn: CMD }), _defineProperty(_KeyActions, Keys.PI, { str: 'pi', fn: CMD }), _defineProperty(_KeyActions, Keys.THETA, { str: 'theta', fn: CMD }), _defineProperty(_KeyActions, Keys.PHI, { str: 'phi', fn: CMD }), _defineProperty(_KeyActions, Keys.ANGLE, { str: 'angle', fn: CMD }), _defineProperty(_KeyActions, Keys.JIAO, { str: '∠', fn: CMD }), _defineProperty(_KeyActions, Keys.PM, { str: 'pm', fn: CMD }), _defineProperty(_KeyActions, Keys.DEGREE, { str: 'degree', fn: CMD }), _defineProperty(_KeyActions, Keys.DU, { str: '°', fn: CMD }), _defineProperty(_KeyActions, Keys.CIRC, { str: 'circ', fn: CMD }), _defineProperty(_KeyActions, Keys.ALPHA, { str: 'alpha', fn: CMD }), _defineProperty(_KeyActions, Keys.BETA, { str: 'beta', fn: CMD }), _defineProperty(_KeyActions, Keys.DOT, { str: 'dot', fn: CMD }), _defineProperty(_KeyActions, Keys.SUBSCRIPT, { str: 'subscript', fn: CMD }), _defineProperty(_KeyActions, Keys.VEC, { str: 'vec', fn: CMD }), _defineProperty(_KeyActions, Keys.OVERLINE, { str: 'overline', fn: CMD }), _defineProperty(_KeyActions, Keys.ABS, { str: '|', fn: CMD }), _defineProperty(_KeyActions, Keys.FRAC_GROUP, { str: '{', fn: CMD }), _defineProperty(_KeyActions, Keys.PRIME, { str: "prime", fn: CMD }), _defineProperty(_KeyActions, Keys.DPRIME, { str: 'dprime', fn: CMD }), _defineProperty(_KeyActions, Keys.PARALLELOGRAM, { str: 'lozenge', fn: CMD }), _defineProperty(_KeyActions, Keys.COORDINATE, { str: 'coordinate', fn: CMD }), _defineProperty(_KeyActions, Keys.BRACKET, { str: '[', fn: CMD }), _defineProperty(_KeyActions, Keys.GAMMA, { str: 'gamma', fn: CMD }), _defineProperty(_KeyActions, Keys.DELTA, { str: 'Delta', fn: CMD }), _defineProperty(_KeyActions, Keys.SMALLDELTA, { str: 'delta', fn: CMD }), _defineProperty(_KeyActions, Keys.EPSILON, { str: 'epsilon', fn: CMD }), _defineProperty(_KeyActions, Keys.VAREPSILON, { str: 'varepsilon', fn: CMD }), _defineProperty(_KeyActions, Keys.ZETA, { str: 'zeta', fn: CMD }), _defineProperty(_KeyActions, Keys.ETA, { str: 'eta', fn: CMD }), _defineProperty(_KeyActions, Keys.VARTHETA, { str: 'vartheta', fn: CMD }), _defineProperty(_KeyActions, Keys.IOTA, { str: 'iota', fn: CMD }), _defineProperty(_KeyActions, Keys.KAPPA, { str: 'kappa', fn: CMD }), _defineProperty(_KeyActions, Keys.LAMBDA, { str: 'lambda', fn: CMD }), _defineProperty(_KeyActions, Keys.MU, { str: 'mu', fn: CMD }), _defineProperty(_KeyActions, Keys.NU, { str: 'nu', fn: CMD }), _defineProperty(_KeyActions, Keys.XI, { str: 'xi', fn: CMD }), _defineProperty(_KeyActions, Keys.RHO, { str: 'rho', fn: CMD }), _defineProperty(_KeyActions, Keys.SIGMA, { str: 'sigma', fn: CMD }), _defineProperty(_KeyActions, Keys.TAU, { str: 'tau', fn: CMD }), _defineProperty(_KeyActions, Keys.UPSILON, { str: 'upsilon', fn: CMD }), _defineProperty(_KeyActions, Keys.CHI, { str: 'chi', fn: CMD }), _defineProperty(_KeyActions, Keys.PSI, { str: 'psi', fn: CMD }), _defineProperty(_KeyActions, Keys.OMEGA, { str: 'omega', fn: CMD }), _defineProperty(_KeyActions, Keys.MAO, { str: ':', fn: CMD }), _defineProperty(_KeyActions, Keys.ODOT, { str: 'odot', fn: CMD }), _defineProperty(_KeyActions, Keys.BECAUSE, { str: 'because', fn: CMD }), _defineProperty(_KeyActions, Keys.THEREFORE, { str: 'therefore', fn: CMD }), _defineProperty(_KeyActions, Keys.TRIANGLE, { str: 'bigtriangleup', fn: CMD }), _defineProperty(_KeyActions, Keys.BIGTRIANGLEUP, { str: 'bigtriangleup', fn: CMD }), _defineProperty(_KeyActions, Keys.CDOT, { str: 'cdot', fn: CMD }), _defineProperty(_KeyActions, Keys.APPROX, { str: 'approx', fn: CMD }), _defineProperty(_KeyActions, Keys.SIM, { str: 'sim', fn: CMD }), _defineProperty(_KeyActions, Keys.CONG, { str: 'cong', fn: CMD }), _defineProperty(_KeyActions, Keys.PERP, { str: 'perp', fn: CMD }), _defineProperty(_KeyActions, Keys.QIE, { str: '且', fn: CMD }), _defineProperty(_KeyActions, Keys.HUO, { str: '或', fn: CMD }), _defineProperty(_KeyActions, Keys.RADICAL, { str: 'nthroot', fn: CMD }), _defineProperty(_KeyActions, Keys.LT, { str: '<', fn: WRITE }), _defineProperty(_KeyActions, Keys.LEQ, { str: '\\leq', fn: WRITE }), _defineProperty(_KeyActions, Keys.GT, { str: '>', fn: WRITE }), _defineProperty(_KeyActions, Keys.GEQ, { str: '\\geq', fn: WRITE }), _defineProperty(_KeyActions, Keys.UP, { str: 'Up', fn: KEYSTROKE }), _defineProperty(_KeyActions, Keys.DOWN, { str: 'Down', fn: KEYSTROKE }), _defineProperty(_KeyActions, Keys.FRAC_INCLUSIVE, { str: 'frac', fn: CMD }), _KeyActions);
