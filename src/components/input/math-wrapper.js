...
const KeyActions = {
    ...
    [Keys.PHI]: {str: 'phi', fn: CMD},
    [Keys.ANGLE]: {str: 'angle', fn: CMD},
    [Keys.JIAO]: {str: '∠', fn: CMD},
    [Keys.PM]: {str: 'pm', fn: CMD},
    [Keys.DEGREE]: {str: 'degree', fn: CMD},
    [Keys.DU]: {str: '°', fn: CMD},
    [Keys.CIRC]: {str: 'circ', fn: CMD},
    [Keys.ALPHA]: {str: 'alpha', fn: CMD},
  // add
    [Keys.BETA]: {str: 'beta', fn: CMD},
    [Keys.DOT]: {str: 'dot', fn: CMD},
    [Keys.SUBSCRIPT]: {str: 'subscript', fn: CMD},
    [Keys.VEC]: {str: 'vec', fn: CMD},
    [Keys.OVERLINE]: {str: 'overline', fn: CMD},
    [Keys.ABS]: {str: '|', fn: CMD},
    [Keys.FRAC_GROUP]: {str: '{', fn: CMD},

    [Keys.PRIME]: {str: "prime", fn: CMD},
    [Keys.DPRIME]: {str: 'dprime', fn: CMD},
    [Keys.PARALLELOGRAM]: {str: 'lozenge', fn: CMD},
    [Keys.COORDINATE]: {str: 'coordinate', fn: CMD},
    [Keys.BRACKET]: {str: '[', fn: CMD},

//
    [Keys.GAMMA]: {str: 'gamma', fn: CMD},
    [Keys.DELTA]: {str: 'Delta', fn: CMD},
    [Keys.SMALLDELTA]: {str: 'delta', fn: CMD},
    [Keys.EPSILON]: {str: 'epsilon', fn: CMD},
    [Keys.VAREPSILON]: {str: 'varepsilon', fn: CMD},
    [Keys.ZETA]: {str: 'zeta', fn: CMD},
    [Keys.ETA]: {str: 'eta', fn: CMD},
    [Keys.VARTHETA]: {str: 'vartheta', fn: CMD},
    [Keys.IOTA]: {str: 'iota', fn: CMD},
    [Keys.KAPPA]: {str: 'kappa', fn: CMD},
    [Keys.LAMBDA]: {str: 'lambda', fn: CMD},
    [Keys.MU]: {str: 'mu', fn: CMD},
    [Keys.NU]: {str: 'nu', fn: CMD},
    [Keys.XI]: {str: 'xi', fn: CMD},
    [Keys.RHO]: {str: 'rho', fn: CMD},
    [Keys.SIGMA]: {str: 'sigma', fn: CMD},
    [Keys.TAU]: {str: 'tau', fn: CMD},
    [Keys.UPSILON]: {str: 'upsilon', fn: CMD},
    [Keys.CHI]: {str: 'chi', fn: CMD},
    [Keys.PSI]: {str: 'psi', fn: CMD},
    [Keys.OMEGA]: {str: 'omega', fn: CMD},
    [Keys.MAO]: {str: ':', fn: CMD},
    [Keys.ODOT]: {str: 'odot', fn: CMD},
    [Keys.BECAUSE]: {str: 'because', fn: CMD},
    [Keys.THEREFORE]: {str: 'therefore', fn: CMD},
    [Keys.TRIANGLE]: {str: 'bigtriangleup', fn: CMD},
    [Keys.BIGTRIANGLEUP]: {str: 'bigtriangleup', fn: CMD},
    [Keys.CDOT]: {str: 'cdot', fn: CMD},
    [Keys.APPROX]: {str: 'approx', fn: CMD},
    [Keys.SIM]: {str: 'sim', fn: CMD},
    [Keys.CONG]: {str: 'cong', fn: CMD},
    [Keys.PERP]: {str: 'perp', fn: CMD},
    [Keys.QIE]: {str: '且', fn: CMD},
    [Keys.HUO]: {str: '或', fn: CMD},
    ...
    [Keys.FRAC_INCLUSIVE]: {str: 'frac', fn: CMD},
};
