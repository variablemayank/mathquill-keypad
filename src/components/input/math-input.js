...
//
    ...
    focus() {
      ...
      //
        ...
        this.props.keypadElement && this.props.keypadElement.setKeyHandler(key => {
    ...
    handleTouchStart(e) {
      ...
      //
        ...
        if(!this.state.focused) {
            ...
            let event2 = new Event('touchend', {"bubbles":true, "cancelable":true});
    ...
    render() {
        ...
        // input.
        const normalBorderWidthPx = 0;
        const focusedBorderWidthPx = 0;
