...
class PopoverStateMachine {
     ...
     */
    onBlur() {
        // console.log('PopoverStateMachine: onBlur')
        this.activePopover = null;
     ...
     */
    onFocus(id) {
        // console.log('PopoverStateMachine: onFocus', id, this.activePopover)
     ...
     */
    onLongPress(id) {
        // console.log('PopoverStateMachine: onLongPress', id, this.activePopover, this.popovers[id])
    ...
    */
    onTrigger(id) {
        // console.log('PopoverStateMachine: onTrigger', id)
     ...
     */
    onTouchEnd(id) {
        // console.log("PopoverStateMachine: onTouchEnd", id, !!this.activePopover);
        ...
        if (inPopover) {
            ...
            if (this._isNodeInsidePopover(this.activePopover, id)) {
                // console.log('inpopover and node inside popover ')
                this.handlers.onClick(id, id, inPopover);
                this.onBlur()
            } else if (this.activePopover === id) {
                // console.log('popover touchend', this.activePopover, id)
            ...
            // for layout purposes.
            // console.log('popover on touch end popoverid', this.popovers[id])
            const keyId = this._defaultNodeForPopover(id);
            const domNodeId = id;
            ...
            // console.log('popover on touch end trigger id', id)
            this.onTrigger(id);
            this.onBlur()
        }
